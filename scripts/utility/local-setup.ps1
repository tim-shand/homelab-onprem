#=====================================================#
# Local Setup: Utility Script (Windows PowerShell)
#=====================================================#
...
# Will promt the user to install missing applications and PowerShell modules.

# NOTE: 
# Requires administrator privileges to run.

# USAGE:
# .\scripts\utility\local-setup.ps1 
...
# Define list of required applications to be install by WinGet.
$requiredApps = @()
